...
public class LiteAppLocalPackageUtils {
    ...
    public static String getLiteAppCache(Context context, String id, String path){
    ...
    public static InputStream getLiteAppStreamCache(Context context, String id, String path){
        String storagePath = "lite/" + id + "/" + path;
        try {
            File file = new File(context.getFilesDir(), storagePath);
            if(!file.exists()){
   ...
   public static void storageLiteAppStreamCache(Context context, String id, String path,
